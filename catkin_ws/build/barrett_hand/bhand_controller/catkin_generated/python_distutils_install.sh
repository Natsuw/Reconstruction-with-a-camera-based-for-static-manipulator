...
echo_and_run cd "/home/sky/catkin_ws/src/barrett_hand/bhand_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/sky/catkin_ws/src/barrett_hand/bhand_controller/setup.py" \
     \
    build --build-base "/home/sky/catkin_ws/build/barrett_hand/bhand_controller" \
    install \
    --root="${DESTDIR-/}" \
